...
Prove o exemplo abaixo e reflita sobre porque não podemos substituir `→` por `↔`.
...
Prove que `∃ n : Nat, n + n = 10`, exibindo a testemunha. Você pode usar {name}`Exists.intro`.
